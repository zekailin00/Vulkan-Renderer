...
enum class KeyCode
{
    ...
    /**
     * IMPORTANT: When the keycodes below are changed
     * The corresponding keycodes in javascipt environment 
     * and in JS input callbacks need to be changed as well.
     */
